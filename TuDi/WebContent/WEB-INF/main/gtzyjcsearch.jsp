...
function refresh(lbh) {
	if(lbh==0) {
		...
		showCondition("wfdw_line","Y");
		showCondition("wfxz_line","Y");
		showCondition("wh_line","Y");
		showCondition("bgqx_line","N");
		showCondition("zrz_line","N");
		showCondition("tm_line","N");
		showCondition("xcsj_line","N");
		...
		showCondition("wfdw_line","N");
		showCondition("wfxz_line","N");
		showCondition("wh_line","Y");
		showCondition("bgqx_line","Y");
		showCondition("zrz_line","Y");
		showCondition("tm_line","Y");
		showCondition("xcsj_line","Y");
...
function getAll() {
	...
	window.location.href("../main/allgtzyjc?lbh="+lbh);
}
</script>
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr>
         ...
         <td align="center" class="td01">
           ...
           <s:form method="post" action="gtzyjcSearch" theme="simple" namespace="/main">
		   <s:token></s:token>
		   <table width="70%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr id="wfdw_line" style="display: inline;" height="50">
				<td class="td1" align="right">违法单位:</td>
				<td class="td2" align="center"><input type="text" name="wfdw" size="25"/></td>
				<td class="td3" align="left"><input type="checkbox" name="wfdwm"/>模糊查询</td>
			  </tr>
			  <tr id="wfxz_line" style="display: inline;" height="50">
				<td class="td1" align="right">违法性质:</td>
				<td class="td2" align="center"><input type="text" name="wfxz" size="25"/></td>
				<td class="td3" align="left"><input type="checkbox" name="wfxzm"/>模糊查询</td>
			  </tr>
			  <tr id="wh_line" style="display: inline;" height="50">
			   ...
			   <tr id="bgqx_line" style="display: none;" height="50">
				<td class="td1" align="right">保管期限:</td>
				<td class="td2" align="center"><input type="text" name="bgqx" size="25"/></td>
				<td class="td3" align="left"><input type="checkbox" name="bgqxm"/>模糊查询</td>
			  </tr>
			   <tr id="zrz_line" style="display: inline;" height="50">
				<td class="td1" align="right">责任者:</td>
				<td class="td2" align="center"><input type="text" name="zrz" size="25"/></td>
				<td class="td3" align="left"><input type="checkbox" name="zrzm"/>模糊查询</td>
			  </tr>
			  <tr id="tm_line" style="display: none;" height="50">
				<td class="td1" align="right">题名:</td>
				<td class="td2" align="center"><input type="text" name="tm" size="25"/></td>
				<td class="td3" align="left"><input type="checkbox" name="tmm"/>模糊查询</td>
			  </tr>
			  <tr id="xcsj_line" style="display: none;" height="50">
				<td class="td1" align="right">形成时间:</td>
				<td class="td2" align="center"><input type="text" name="xcsj" size="25"/></td>
				<td class="td3" align="left"><input type="checkbox" name="xcsjm"/>模糊查询</td>
			  </tr>
			  ...
			  <tr>
			  	...
			  	<td class="td2" align="center">
			  		<select id="lb_select" name="lbh" onchange="refresh(this.options[this.options.selectedIndex].value)">
			  			...
			  			<option value="11">来访信访材料</option>
			  			<option value="12">案件处理材料</option>
			  		</select> 
			  	</td>
			  	<td></td>
			  </tr>
