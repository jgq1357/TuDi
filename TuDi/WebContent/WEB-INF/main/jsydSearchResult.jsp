...
<script type="text/javascript">
	...
	function getResults(currPage,pageNum) {
		...
		window.location.href("../main/jsydSearch?pageNum="+currPage+"&flag=Y");
       ...
       <tr>
         ...
         <td align="center" class="td01">
           ...
           <table id = "result_table" class="sortable" width="95%" border="0" cellspacing="0" cellpadding="0" style="border: 1px">
			 ...
			 <tbody>
				<s:iterator id="d" value="jsyds" status="jsyd">
					<tr ondblclick="showTif('${daid}','${qzh}-${mlh}-${flh}-${ajh}','000001','ds10','${view}','jsyd')">
						<td id="result" style="border: 1px solid black; text-align: center;"><s:property value="#jsyd.index+1"/></td>
						<td id="result" style="border: 1px solid black; text-align: center;">${qzh}-${mlh}-${flh}-${ajh}</td>
						<td id="result" style="border: 1px solid black; text-align: center;">${sqr}&nbsp;</td>
						<td id="result" style="border: 1px solid black; text-align: center;">${tdzl}&nbsp;</td>
						<td id="result" style="border: 1px solid black; text-align: center;">${zrf}&nbsp;</td>
						<td id="result" style="border: 1px solid black; text-align: center;">${srf}&nbsp;</td>
						<td id="result" style="border: 1px solid black; text-align: center;"><a href="#" onclick="showTif('${daid}','${qzh}-${mlh}-${flh}-${ajh}','000001','ds10','${view}','jsyd')">点击查看</a></td>
					</tr>
				</s:iterator>
			 </tbody>
			</table>
