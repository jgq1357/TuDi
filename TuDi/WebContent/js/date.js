function atCalendarControl(){
  ...
  this.addCalendarPad=function(){
   document.write("<div id='divCalendarpad' style='z-index: 6;position:absolute;top:100;left:0;width:255;height:187;display:none;'>");
   document.write("<iframe frameborder=0 height=189 width=250></iframe>");
   document.write("<div style='z-index: 6;position:absolute;top:2;left:2;width:250;height:187;background-color:#336699;'></div>");
   document.write("</div>");
  ...
  this.addCalendarBoard=function(){
   ...
   divBoard.style.cssText="z-index: 6;position:absolute;top:0;left:0;width:250;height:187;border:0 outset;background-color:buttonface;";
 
   var tbBoard=document.createElement("table");
   divBoard.insertAdjacentElement("beforeEnd",tbBoard);
   tbBoard.style.cssText="z-index: 6;position:absolute;top:2;left:2;width:248;height:10;font-size:9pt;";
  ...
  /************** 设置各功能按钮的功能 *********************/
   ...
   for (var i = 0; i < 7; i++) {
    ...
    tbCell.align="center";
    tbCell.width=35;
    tbCell.style.cssText="z-index: 6;cursor:default;border:1 solid #99CCCC;background-color:#99CCCC;";
   }
   ...
   tbBody.style.cssText="z-index: 6;position:relative;top:0;left:0;width:245;height:103;font-size:9pt;"
...
/************** 加入功能按钮公共样式 *********************/
  this.insertTbCell=function(trRow,cellIndex,TXT,trAlign,tbColSpan){
   ...
   btnCell.value=TXT;
   btnCell.style.cssText="z-index: 6;width:100%;border:1 outset;background-color:buttonface;";
  ...
  // }
   btnCell.onmouseup=function(){
    btnCell.style.cssText="z-index: 6;width:100%;border:1 outset;background-color:#F0F0F0;";
   }
