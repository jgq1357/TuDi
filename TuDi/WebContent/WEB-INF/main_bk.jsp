    ...
    <td align="center" valign="top" background="../images/main_17.gif"><br>
      ...
      <tr>
        ...
        <td align="center" class="td01"><table width="95%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25"><img src="../images/main_28.gif" width="9" height="9" align="absmiddle"> <strong>系统公告</strong></td>
            <td width="35" align="right"><a href="#" target="mainFrame"><img src="../images/main_53.gif" width="35" height="9" border="0"></a></td>
          </tr>
          <tr>
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td valign="top" class="td08"><span> <a href="#">2013-07-22到2013-07-24系统维护</a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><span><a href="#">关于国庆放假安排公告 2013-07-30</a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><span><a href="#">关于国庆放假安排公告 2013-07-30</a></span></td>
      ...
      <tr>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="15"><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">张三 提交请假申请 2013-07-30</a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">下午1号会议室会议 2013-07-30</a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">下午1号会议室会议 2013-07-30</a></td>
        ...
        <table width="95%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="center" class="td01"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="25"><img src="../images/main_28.gif" width="9" height="9" align="absmiddle"> <strong>我的待办</strong></td>
                  <td width="35" align="right"><a href="#"><img src="../images/main_53.gif" width="35" height="9" border="0"></a></td>
                </tr>
                <tr>
                  <td height="1" class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                  <td class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="15"><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">请归还2012-12-20日借阅的李某、王某、吴某、张某的档案</a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                        ...
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">2013-11-23 下午在407举行人力资源部年度考核大会，请准时参加</a></td>
                        </tr>
                    </table></td>
                  </tr>
                </table>
