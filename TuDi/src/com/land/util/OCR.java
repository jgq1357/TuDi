...
public class OCR {
    ...
    private String tessPath = Constant.TESSERACTPATH;
    ...
    public String recognizeText(File imageFile, String imageFormat) throws Exception {
       // File tempImage = imageFile;// ImageIOHelper.createImage(imageFile,imageFormat);
        ...
        File file = new File(imageFile.getParentFile(), imageFile.getName()+"_temp.jpg");
        ...
        File file_ex = new File(imageFile.getParentFile(), imageFile.getName()+"_temp_ex.jpg");
        ...
        cmd.add(LANG_OPTION);
        // cmd.add("chi_sim");
        cmd.add("chi_sim");// 有个verify的包，是从火车订票中提取出来的
        //cmd.add("eng");// 有个verify的包，是从火车订票中提取出来的
        cmd.add(OPTION);
        cmd.add("6");
        ...
        cmd.set(1, imageFile.getName()+"_temp_ex.jpg"/* tempImage.getName() */);
        pb.command(cmd);
