...
<script type="text/javascript">
	...
	function getResults(currPage,pageNum) {
		...
		window.location.href("../main/gtzyjcSearch?pageNum="+currPage+"&flag=Y");
       ...
       <tr>
         ...
         <td align="center" class="td01">
           ...
           <table id = "result_table" class="sortable" width="95%" border="0" cellspacing="0" cellpadding="0" style="border: 1px">
			 ...
			 <tbody>
				<s:iterator id="d" value="gtzyjcs" status="gtzyjc">
					<tr ondblclick="showTif('${daid}','${qzh}-${mlh}-${flh}-${ajh}','000001','ds10','${view}','gtzyjc')">
						<td id="result" style="border: 1px solid black; text-align: center;"><s:property value="#gtzyjc.index+1"/></td>
						...
						<td id="result" style="border: 1px solid black; text-align: center;">${dworgr}&nbsp;</td>
						<td id="result" style="border: 1px solid black; text-align: center;">${wfxz}&nbsp;</td>
						<td id="result" style="border: 1px solid black; text-align: center;"><a href="#" onclick="showTif('${daid}','${qzh}-${mlh}-${flh}-${ajh}','000001','ds10','${view}','gtzyjc')">点击查看</a></td>
					</tr>
				</s:iterator>
			 </tbody>
			</table>
