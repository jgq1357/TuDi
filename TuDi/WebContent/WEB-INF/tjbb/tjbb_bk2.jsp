...
<div align="center" style="overflow:auto;width: 100%; height: 45%;top: 2%;left: 2%;border: 1px solid #ccc;position: absolute;">
	<table border="1" bordercolor="#7B7B7B" style="max-height:55%; overflow:scroll; border-collapse:collapse; table-layout:fixed; " cellpadding="0" cellspacing="0">
		<tr bgcolor="#2894FF" >
			...
			<td>(B)财务类</td>
			<td>(C)地籍类</td>
			<td><font size="2">(D)利用规划类</font> </td>
			<td><font size="2">(E)建设用地类</font> </td>
			<td><font size="2">(F)资源监察类</font> </td>
			<td><font size="2">(G)科技信息类</font> </td>
			<td><font size="2">(H)电子声像类</font> </td>
			<td><font size="2">(I)地质矿产类</font> </td>
		</tr>
...
<br>
<div align="center" style="border: 1px solid #ccc; left: 2%;width: 100%; height: 45%;top: 50%;position: absolute;">
