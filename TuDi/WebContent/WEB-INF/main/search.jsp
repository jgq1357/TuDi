         ...
         <td align="center" class="td01">
		   ...
		   <table width="70%" border="0" cellspacing="0" cellpadding="0">
			  <!--<tr id="dah_line" style="display: inline;" height="50">
			    ...
			    <tr id="dah_line" style="display: inline;" height="50">
				<td class="td1" align="right">目录号：</td>
				<td class="td2" align="center"><input type="text" name="mlh" size="25"/></td>
				<td class="td3" align="left"><input type="checkbox" name="mlhm"/>模糊查询</td>
			  </tr>
			  
			    <tr id="dah_line" style="display: inline;" height="50">
				<td class="td1" align="right">分类号:</td>
				<td class="td2" align="center"><input type="text" name="flh" size="25"/></td>
				<td class="td3" align="left"><input type="checkbox" name="flhm"/>模糊查询</td>
			  </tr>	
			  
			    <tr id="dah_line" style="display: inline;" height="50">
				<td class="td1" align="right">案卷号:</td>
				<td class="td2" align="center"><input type="text" name="ajh" size="25"/></td>
				<td class="td3" align="left"><input type="checkbox" name="ajhm"/>模糊查询</td>
			  </tr>		
